...
### Summary
In This project, we analysed 5 different datasets related to NBA statistics and player statistics and thei salary.
...
Note that the approach taken in this project is just one possible method for selecting the best players within a budget constraint, and there are other approaches and factors to consider (such as team chemistry, play style, opponent matchup and injury history etc).
